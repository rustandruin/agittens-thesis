...
fnorms = cumsum(s.^2);
A = diag(s); % make maximally coherent
...
th = title('Relative residual spectral errors for $\mathbf{B}$');
set(th, 'interpreter', 'latex');
lh = legend('$\|\mathbf{B} - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_2 / \|\mathbf{B} - \mathbf{B}_k\|_2$, Gaussian', ...
            '$\|\mathbf{B} - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_2/ \|\mathbf{B} - \mathbf{B}_k\|_2$, SRHT', ...
            'Location', 'SouthWest');
% lh = legend('$\|\mathbf{B} - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_2 / \|\mathbf{B} - \mathbf{B}_k\|_2$, Gaussian', ...
%             '$\|\mathbf{B} - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_2/ \|\mathbf{B} - \mathbf{B}_k\|_2$, SRHT', ...
%             '$\|\mathbf{B} - \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B})\|_2/\|\mathbf{B} - \mathbf{B}_k\|_2$, Gaussian', ...
%             '$\|\mathbf{B} - \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B})\|_2/\|\mathbf{B} - \mathbf{B}_k\|_2$, SRHT', 'Location', 'SouthWest')
set(lh, 'interpreter', 'latex');

printcf('experimentB-residual-spectral.pdf', 16, 7, 6);
...
xlabel('k (target rank)');
yh = ylabel('relative error');
th = title('Relative residual Frobenius errors for $\mathbf{B}$');
set(th, 'interpreter', 'latex');
lh = legend('$\|\mathbf{B} - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_F / \|\mathbf{B} - \mathbf{B}_k\|_F$, Gaussian', ...
            '$\|\mathbf{B} - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_F / \|\mathbf{B} - \mathbf{B}_k\|_F$, SRHT', ...
            'Location', 'SouthWest');
%lh = legend('$\|\mathbf{B} - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_F / \|\mathbf{B} - \mathbf{B}_k\|_F$, Gaussian', ...
%            '$\|\mathbf{B} - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_F / \|\mathbf{B} - \mathbf{B}_k\|_F$, SRHT', ...
%            '$\|\mathbf{B} - \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B})\|_F / \|\mathbf{B} - \mathbf{B}_k\|_F$, Gaussian', ...
%            '$\|\mathbf{B} - \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B})\|_F / \|\mathbf{B} - \mathbf{B}_k\|_F$, SRHT', 'Location', 'SouthWest');
set(lh, 'interpreter', 'latex');

printcf('experimentB-residual-frobenius.pdf', 16, 7, 6);
...
xlabel('k (target rank)');
yh = ylabel('relative error');
th = title('Relative forward spectral errors for $\mathbf{B}$');
set(th, 'interpreter', 'latex');
lh = legend('$\|\mathbf{B}_k - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_2 / \|\mathbf{B}_k\|_2$, Gaussian', ...
            '$\|\mathbf{B}_k - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_2/ \|\mathbf{B}_k\|_2$, SRHT', ...
            '$\|\mathbf{B}_k - \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B})\|_2/\|\mathbf{B}_k\|_2$, Gaussian', ...
            '$\|\mathbf{B}_k - \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B})\|_2/\|\mathbf{B}_k\|_2$, SRHT', 'Location', 'SouthWest');
set(lh, 'interpreter', 'latex');

printcf('experimentB-forward-spectral.pdf', 16, 7, 6);
...
xlabel('k (target rank)');
yh = ylabel('relative error');
th = title('Relative forward Frobenius errors for $\mathbf{B}$');
set(th, 'interpreter', 'latex');
lh = legend('$\|\mathbf{B}_k - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_F / \|\mathbf{B}_k\|_F$, Gaussian', ...
            '$\|\mathbf{B}_k - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B} \|_F/ \|\mathbf{B}_k\|_F$, SRHT', ...
            '$\|\mathbf{B}_k - \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B})\|_F/\|\mathbf{B}_k\|_F$, Gaussian', ...
            '$\|\mathbf{B}_k - \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B})\|_F/\|\mathbf{B}_k\|_F$, SRHT', 'Location', 'NorthEast');
set(lh, 'interpreter', 'latex');

printcf('experimentB-forward-frobenius.pdf', 16, 7, 6);
...
th = title({'Number of samples needed to achieve $\|\mathbf{B} - \mathbf{L}\|_F \leq (1+\varepsilon) \|\mathbf{B} - \mathbf{B}_k\|_F$ with probability at least 1/2'});
set(th, 'interpreter', 'latex');
set(yh, 'interpreter', 'latex');
lh = legend('$\mathbf{L} = \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B}, \varepsilon = 1/2$', ...
            '$\mathbf{L} = \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B}, \varepsilon = 1/3$', ...
            '$\mathbf{L} = \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B}, \varepsilon = 1/6$', ...
            '$\mathbf{L} = \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B}), \varepsilon = 1/2$', ...
            '$\mathbf{L} = \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B}), \varepsilon = 1/3$', ...
            '$\mathbf{L} = \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B}), \varepsilon = 1/6$', ...
            'Location', 'SouthEast');
set(lh, 'interpreter', 'latex');

printcf('experimentB-empirically-necessary-r.pdf', 16, 12, 6);
...
th = title('Guaranteed vs observed spectral errors for $\mathbf{B}$');
set(th, 'interpreter', 'latex');
lh = legend('spectral error bound of Thm 4 / $\|\mathbf{B} - \mathbf{B_k}\|_2$', ...
            '$\|\mathbf{B} - \mathbf{P}_{\mathbf{B}\mathbf{S}} \mathbf{B}\|_2 / \|\mathbf{B} - \mathbf{B_k}\|_2$',...
            '$\|\mathbf{B} - \mathbf{\Pi}_{\mathbf{B}\mathbf{S}, k}^{\mathrm{F}}(\mathbf{B})\|_2 / \|\mathbf{B} - \mathbf{B}_k\|_2$');
set(lh, 'interpreter', 'latex');

printcf('experimentB-actual-versus-predicted-spectral-error.pdf', 16, 6, 6);

%% Save data so the visualization parts can be run without the data generation parts

save('experimentBdata.mat');